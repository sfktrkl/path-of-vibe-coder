export const items = {
  ...
  // AI Items - Moving these to premium category since they're advanced items
  ai_processor: {
    id: "ai_processor",
    name: "AI Processor",
  ...
  // Bio-AI Integration Items - Moving to premium
  bio_neural_implant: {
  ...
  // Quantum AI Items - Moving to premium
  quantum_processor: {
  ...
  // Reality Engineering Items - Moving to premium
  ...
  // Consciousness Engineering Items - Moving to premium
  mind_mapper: {
    id: "mind_mapper",
    name: "Mind Mapper",
  ...
  // Matrix Control Items - Moving to premium
